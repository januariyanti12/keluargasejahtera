...
<script src="dist/leaflet.js"></script>
	...
	<script>
		function peta_awal() {
			...
			var map = L.map('map').setView([0.5285, 122.3467], 12);
			...
			//$sql = "SELECT locations.id_lokasi,locations.nama_lokasi,locations.lat, locations.lng,lokasi_details.id_lokasi,lokasi_details.nama_ukuran FROM locations INNER JOIN lokasi_details ON locations.id_lokasi=lokasi_details.id_lokasi;";
			//$sql = ("SELECT * FROM locations ");
			$sql = "select * from locations p inner join lokasi_details b on p.id_lokasi=b.id_lokasi";
