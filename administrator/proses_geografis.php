...
require("config.php");
    ...
    $query = sprintf("INSERT INTO lokasi(id_lokasi,nama_penduduk, lat, lng) " .
        " VALUES ('$nourut','$namain','$lat', '$lng');",
		mysqli_real_escape_string($connections,$nourut),
	...
	<div class="container">
	<?php
	echo "<center><b><br><br><br><br>DATA BERHASIL DIINPUT<br><br><br><br></b></center>"
?>
	</div>
	<script>
			setTimeout(function() {
						window.location.href = "user-map.php";
				}, 2000);
</script>